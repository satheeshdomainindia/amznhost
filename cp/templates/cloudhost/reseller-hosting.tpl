  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <h1 class="color-white text-uppercase">Reseller <strong> Hosting</strong></h1>
...
<!-- ========= Pricing Table Start ========= -->
{if count($resellerhosting) gt 0 && ($resellerhosting.0.monthly gt 0 || $resellerhosting.0.annually gt 0 || $resellerhosting.0.biennially gt 0 || $resellerhosting.0.triennially gt 0)}
<section class="pricing_table3 text-center bottom_padding_xs">
  <div class="container">
    <div class="row">
    {foreach $resellerhosting as $myproduct}
      <div class="col-md-3 col-sm-3 col-xs-12">
        <div class="plan_box">
          <div class="plan_intro color-white padding_tb_40">
            <div class="price font-32"> {$myproduct.prefix} {$myproduct.monthly}<small>/mo</small> </div>
            <h5 class="padding_top_20 text-uppercase">{$myproduct.name}</h5>
          </div>
          <ul class="color-grey margin_top_20">
  ...
  <div class="container">
    <div class="row">
      <div class="col col-md-6">
        <h3 class="color-white">printing and industry Lorem Ipsumu.</h3>
...
<section class="our_services_main background-grey text-center">
  <div class="container">
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="heading padding_bottom_100">
