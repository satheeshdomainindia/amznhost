<div class="upgrade">
    ...
    {else}
        ...
        <div class="product-to-be-upgraded">
            <div class="row">
                ...
                <div class="col-sm-3 text-right">
                    <a href="{$WEB_ROOT}/clientarea.php?action=productdetails&id={if $serviceToBeUpgraded->isService()}{$serviceToBeUpgraded->id}{elseif $serviceToBeUpgraded->isAddon()}{$serviceToBeUpgraded->service->id}{/if}" class="btn primary-solid-btn">
                        {lang key="manage"}
                    </a>
                </div>
            </div>
        ...
        <h3 class="mb-0">{lang key="upgradeService.chooseNew"}</h3>
                    ...
                    <div class="product text-center">
                        ...
                        <div class="footer">
                            <form method="post" action="{routePath('upgrade-add-to-cart')}">
                                ...
                                <button type="submit" class="btn btn-block primary-solid-btn" id="btnUpgradeSelect-{$product->productKey}"{if !$product->eligibleForUpgrade} disabled="disabled"{/if}>
