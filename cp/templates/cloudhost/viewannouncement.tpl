...
<div class="announcement-single">
    <span class="article-date"><i class="fal fa-calendar-alt"></i>  {$carbon->createFromTimestamp($timestamp)->format('l, F j, Y')}</span>
    {$text}
</div>
...
<p>
    <a href="{routePath('announcement-index')}" class="btn outline-btn btn-sm">{$LANG.clientareabacklink}</a>
</p>
