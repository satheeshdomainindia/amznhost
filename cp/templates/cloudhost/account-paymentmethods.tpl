...
<table class="table table-striped table-bordered" id="payMethodList">
    <tr>
        <th></th>
...
<p>
    {if $allowCreditCard}
        <a href="{routePath('account-paymentmethods-add')}" class="btn primary-solid-btn" data-role="add-new-credit-card">
            {$LANG.paymentMethods.addNewCC}
        </a>
    {/if}
    {if $allowBankDetails}
        <a href="{routePathWithQuery('account-paymentmethods-add', null, 'type=bankacct')}" class="btn outline-btn">
