<div class="container">
    <div class="store-order-container">
        <form method="post" action="{routePath('cart-order-addtocart')}" id="frmAddToCart">
            ...
            <div class="row">
                ...
                <div class="col-sm-5">
                    ...
                    <div class="payment-term">
                        <h5>{lang key='store.choosePaymentTerm'}</h5>
            ...
            <br>
            <h5>{lang key='store.chooseDomain'}</h5>
            ...
            <div class="tab-content store-domain-tab-content">
                ...
                <div class="row mt-20">
                    ...
                    <div class="col-sm-7 text-right">
                        <button type="submit" name="continue" value="1" class="btn outline-btn">
                            {lang key='orderForm.continueShopping'}
                        </button>
                        <button type="submit" name="checkout" value="1" class="btn primary-solid-btn">
